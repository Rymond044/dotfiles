...
> - **Desktop overview** – your wallpaper, waybar, and a clean desktop.
> - **Rofi in action** – one screenshot for the app launcher, one for the power menu, and one for the battery manager.
> - **Notification center** – a few notifications visible or the center popped out.
> - **Terminal** – showing neofetch/fastfetch and maybe a color palette generated by wallust.
> - **Btop** – with your custom theme applied.
> - **Wallpaper switching** – a before/after to illustrate color scheme generation.
